...
public class CaloriesChart {
    ...
    public Component getChart(List<Routine> rList) {
        for (int i = 0; i < rList.size(); i++) {
            ...
            if (i == 0) {
                val7 = new BigDecimal(r.getCalories_burned());
                cat7 = r.getDayOfWeek();
            }
            else if(i == 1) {
                val6 = new BigDecimal(r.getCalories_burned());
                cat6 = r.getDayOfWeek();
            }
            else if(i == 2) {
                val5 = new BigDecimal(r.getCalories_burned());
                cat5 = r.getDayOfWeek();
            }
            else if (i == 3) {
                val4 = new BigDecimal(r.getCalories_burned());
                cat4 = r.getDayOfWeek();

            }
            else if (i == 4) {
                val3 = new BigDecimal(r.getCalories_burned());
                cat3 = r.getDayOfWeek();
                
            }
            else if (i == 5) {
                val2 = new BigDecimal(r.getCalories_burned());
                cat2 = r.getDayOfWeek();
         
            }
            else if (i == 6) {
                val1 = new BigDecimal(r.getCalories_burned());
                cat1 = r.getDayOfWeek();
    ...
    public Component getChart() {
        ...
        conf.setTitle("Calories Burned - Weekly");
        ...
        conf.addSeries(new ListSeries("Calories", val1, val2, val3, val4, val5, val6, val7));
