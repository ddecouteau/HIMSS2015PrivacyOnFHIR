 ...
 *       &lt;sequence>
 *         &lt;element ref="{urn:hl7-org:v3}ObligationPolicy" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ApplicableObligationPolicies {
     ...
     * This is why there is not a <CODE>set</CODE> method for the obligationPolicy property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getObligationPolicy().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<ObligationPolicy> getObligationPolicy() {
        if (obligationPolicy == null) {
            obligationPolicy = new ArrayList<ObligationPolicy>();
        }
